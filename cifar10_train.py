...
train_generator = train_datagen.flow_from_directory(
        'C:\\work\\Images\\xiaomai01\\train',  # this is the target directory
...
if not data_augmentation:
    ...
    model.fit_generator(train_generator,
                        ...
                        epochs=epochs,
                        validation_data=validation_generator,validation_steps=8000 // batch_size,)
    # model.fit_generator(train_generator,
